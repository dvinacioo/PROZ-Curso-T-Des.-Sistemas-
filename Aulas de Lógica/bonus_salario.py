...
O programa deve ser estruturado da seguinte maneira: Inicialmente, ele solicita ao usuário que insira a pontuação do funcionário. Dependendo dessa pontuação, o programa deve seguir um fluxo condicional. Se a pontuação for maior ou igual a 70, o funcionário recebe um bônus de 20% sobre o salário base. Se a pontuação for entre 50 e 69, o bônus é de 10%. Para pontuações abaixo de 50, não há bônus. O programa deve exibir o valor do bônus e uma mensagem personalizada sobre o desempenho.
